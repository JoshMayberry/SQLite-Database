...
${imports if imports else "target_metadata = None"}
...
def run_migrations_offline():
	...
	alembic.context.configure(url = url, target_metadata = target_metadata, literal_binds = True, process_revision_directives = writer)
